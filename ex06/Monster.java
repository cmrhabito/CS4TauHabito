...
public class Monster {
    public final String name, type, strongAgainst, weakAgainst;
    public int maxHP, hp, xp, lvl; // changed to public
    public double atk, def; // changed atk and def into double
